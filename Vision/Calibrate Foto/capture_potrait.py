...
auto_capture = False
fileName = r"D:\Ahya Rochim\Kuliah\BANDHAYUDHA\Data Foto KFS 2" #path foldernyan nya
os.makedirs(fileName, exist_ok=True)

yaml_file = r'D:\Ahya Rochim\Kuliah\BANDHAYUDHA\PROJECT BANDHA\Calibration_Matrix.yaml'
...
def UndistortVidio():
    ...
    while True:
        ...
        if UndistortVidioFrame is None:
            continue  # skip frame kalau gagal

        # rotate setelah dipastikan ada isi
        UndistortVidioFrame = cv2.rotate(UndistortVidioFrame, cv2.ROTATE_90_CLOCKWISE)
